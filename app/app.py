...
# Load model
cnn_model = tf.keras.models.load_model(STATIC_FOLDER + "/model/" + "model.h5")
...
def classify(model, image_path):
    ...
    prob3 = classified_prob[2]
    prob4 = classified_prob[3]


    return label1, label2, label3, label4, prob1, prob2, prob3, prob4
...
def upload_file():
    ...
    if request.method == "GET":
        ...
        label1, label2, label3, label4, prob1, prob2, prob3, prob4 = classify(cnn_model, upload_image_path)

    return render_template(
        "classify.html", image_file_name=file.filename, label1=label1, label2=label2, label3=label3
        , label4=label4, prob1=prob1 , prob2=prob2, prob3=prob3, prob4=prob4
    )
